import Klasy.*;
import KlasyAbstrakcyjne.*;
import Rodzaje_Samochodow.*;

import static Enumeracje.Platnosc.*;
import static Enumeracje.TypSamochodu.*;
...
public class CarshareTest {
    ...
    static double cena(Koszyk k, String markaSamochodu) {
        ...
        for( Samochod s : k ) {
            if (s.getNazwa().equals(markaSamochodu))
                result += s.obliczLacznaCene(k.getKlient());
        }
    ...
    public static void main(String[] args) {
        ...
        // true oznacza, że w przypadku braku środków aplikacja sama odłoży nadmiarowe kilometry/samochody,
